...
//      version:		2005Q3V1
//      comment:		
//      configuration:	 -instname "fifo_mem" -words 16 -bits 32 -frequency 200 -ring_width 2 -mux 1 -drive 3 -write_mask off -wp_size 8 -top_layer met6 -power_type rings -horiz met3 -vert met2 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND -dpccm on -asvm off
//
//      Verilog model for Synchronous Dual-Port Register File
//
//      Instance Name:  fifo_mem
//      Words:          16
//      Word Width:     32
//      Pipeline:       No
//
//      Creation Date:  2024-03-12 06:58:09Z
//      Version: 	2005Q3V1
//
